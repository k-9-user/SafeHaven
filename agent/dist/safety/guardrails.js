 ...
 */
export function ensureDisclaimer(response, locale = 'en') {
...
export function checkForScam(text) {
    ...
    return {
        isSuspicious: true,
        warningMessage: 'WARNING: This message shows signs of a scam. Legitimate financial services never guarantee returns, never promise to "double your money," and will NEVER ask for your private key or seed phrase. Please do not send any money or share any wallet information.',
    };
}
