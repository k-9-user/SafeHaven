...
async function recoverPublicKey({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-C6SryZP9.js");
	return `0x${(() => {
...
var pi = 0, _n = "identity", yi = si, En = (r) => Ke$2(pi, yi(r));
...
function _t(s) {
	...
	if (typeof s == "object") return Object.assign(Object.create(t), s);
	return s;
}
function it(s) {
...
var AppKit = class extends AppKitBaseClient {
	...
	async injectModalUi() {
		if (!isInitialized && CoreHelperUtil.isClient()) {
			await import("./basic-v0g7rIWQ.js");
			await import("./w3m-modal-DnYdjuH6.js");
...
//# sourceMappingURL=core-Ca8H0YPU.js.map