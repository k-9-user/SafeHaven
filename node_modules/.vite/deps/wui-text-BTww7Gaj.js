...
import { a as nothing, c as notEqual, i as noChange, l as css, n as _$LH, r as html, s as defaultConverter, t as LitElement } from "./lit-CdLoLiqS.js";
import { a as elementStyles, i as colorStyles, n as customElement, r as UiHelperUtil, s as resetStyles } from "./ConstantsUtil-PwGtXiLn.js";
...
var ICONS = {
	add: async () => (await import("./add-DL0pNiP6.js")).addSvg,
	allWallets: async () => (await import("./all-wallets-BNFgXcbv.js")).allWalletsSvg,
	arrowBottomCircle: async () => (await import("./arrow-bottom-circle-pK5w7pIv.js")).arrowBottomCircleSvg,
	appStore: async () => (await import("./app-store-Z-kJESI6.js")).appStoreSvg,
	apple: async () => (await import("./apple-C4aszzXb.js")).appleSvg,
	arrowBottom: async () => (await import("./arrow-bottom-D4RVLYd5.js")).arrowBottomSvg,
	arrowLeft: async () => (await import("./arrow-left-CrAMHQB5.js")).arrowLeftSvg,
	arrowRight: async () => (await import("./arrow-right-7DogEdW7.js")).arrowRightSvg,
	arrowTop: async () => (await import("./arrow-top-SzBnWJUa.js")).arrowTopSvg,
	bank: async () => (await import("./bank-BESZu_PE.js")).bankSvg,
	browser: async () => (await import("./browser-BMCikdby.js")).browserSvg,
	card: async () => (await import("./card-BuDhi3co.js")).cardSvg,
	checkmark: async () => (await import("./checkmark-CEG2Qx_R.js")).checkmarkSvg,
	checkmarkBold: async () => (await import("./checkmark-bold-Cugjsa6g.js")).checkmarkBoldSvg,
	chevronBottom: async () => (await import("./chevron-bottom-BpNz58FG.js")).chevronBottomSvg,
	chevronLeft: async () => (await import("./chevron-left-BkcCChFa.js")).chevronLeftSvg,
	chevronRight: async () => (await import("./chevron-right-Cmw2EX9b.js")).chevronRightSvg,
	chevronTop: async () => (await import("./chevron-top-DU0uAQMv.js")).chevronTopSvg,
	chromeStore: async () => (await import("./chrome-store-CbezBvYv.js")).chromeStoreSvg,
	clock: async () => (await import("./clock-BbIvuNnr.js")).clockSvg,
	close: async () => (await import("./close-BY6bMWmX.js")).closeSvg,
	compass: async () => (await import("./compass-8tWw75xv.js")).compassSvg,
	coinPlaceholder: async () => (await import("./coinPlaceholder-1Z0V6vaq.js")).coinPlaceholderSvg,
	copy: async () => (await import("./copy-P6J5vGdu.js")).copySvg,
	cursor: async () => (await import("./cursor-DraMRXAZ.js")).cursorSvg,
	cursorTransparent: async () => (await import("./cursor-transparent-YthQ9jbB.js")).cursorTransparentSvg,
	desktop: async () => (await import("./desktop-BaYVX-JX.js")).desktopSvg,
	disconnect: async () => (await import("./disconnect-DJaTYDWm.js")).disconnectSvg,
	discord: async () => (await import("./discord-DEcuBe9p.js")).discordSvg,
	etherscan: async () => (await import("./etherscan-CIWJWRCQ.js")).etherscanSvg,
	extension: async () => (await import("./extension-4JCEGyUs.js")).extensionSvg,
	externalLink: async () => (await import("./external-link-CEg9H_Ps.js")).externalLinkSvg,
	facebook: async () => (await import("./facebook-BY9wo1DN.js")).facebookSvg,
	farcaster: async () => (await import("./farcaster-DG8bbjxJ.js")).farcasterSvg,
	filters: async () => (await import("./filters-BMtyujcw.js")).filtersSvg,
	github: async () => (await import("./github-hM9GXW0Y.js")).githubSvg,
	google: async () => (await import("./google-CoeQIdYz.js")).googleSvg,
	helpCircle: async () => (await import("./help-circle-C_stutv9.js")).helpCircleSvg,
	image: async () => (await import("./image-Ni0ZBI0p.js")).imageSvg,
	id: async () => (await import("./id-BM1Qv14p.js")).idSvg,
	infoCircle: async () => (await import("./info-circle-CqglSIHx.js")).infoCircleSvg,
	lightbulb: async () => (await import("./lightbulb-BdS8o6Nc.js")).lightbulbSvg,
	mail: async () => (await import("./mail-DlrQVs1w.js")).mailSvg,
	mobile: async () => (await import("./mobile-DD6MzwcZ.js")).mobileSvg,
	more: async () => (await import("./more-CeU8ETM6.js")).moreSvg,
	networkPlaceholder: async () => (await import("./network-placeholder-BnBuMP-Z.js")).networkPlaceholderSvg,
	nftPlaceholder: async () => (await import("./nftPlaceholder-CTrsDptX.js")).nftPlaceholderSvg,
	off: async () => (await import("./off-DTRiAA_S.js")).offSvg,
	playStore: async () => (await import("./play-store-BnX_yjlQ.js")).playStoreSvg,
	plus: async () => (await import("./plus-DTIFigbY.js")).plusSvg,
	qrCode: async () => (await import("./qr-code-BFsrYRsl.js")).qrCodeIcon,
	recycleHorizontal: async () => (await import("./recycle-horizontal-BztJBfjK.js")).recycleHorizontalSvg,
	refresh: async () => (await import("./refresh-yFm6aIwi.js")).refreshSvg,
	search: async () => (await import("./search-CgvZzSoG.js")).searchSvg,
	send: async () => (await import("./send-DkfZhyoN.js")).sendSvg,
	swapHorizontal: async () => (await import("./swapHorizontal-CZ5sTbcP.js")).swapHorizontalSvg,
	swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-CgXfej7g.js")).swapHorizontalMediumSvg,
	swapHorizontalBold: async () => (await import("./swapHorizontalBold-Bpgn8TiC.js")).swapHorizontalBoldSvg,
	swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-DjYnJyJV.js")).swapHorizontalRoundedBoldSvg,
	swapVertical: async () => (await import("./swapVertical-Dj6Sz-qV.js")).swapVerticalSvg,
	telegram: async () => (await import("./telegram-RVMT4Q1s.js")).telegramSvg,
	threeDots: async () => (await import("./three-dots-CF1UcV59.js")).threeDotsSvg,
	twitch: async () => (await import("./twitch-ClR4X3C-.js")).twitchSvg,
	twitter: async () => (await import("./x-CetPrB3D.js")).xSvg,
	twitterIcon: async () => (await import("./twitterIcon-vvrYsIyD.js")).twitterIconSvg,
	verify: async () => (await import("./verify-DJkn_VQ0.js")).verifySvg,
	verifyFilled: async () => (await import("./verify-filled-BikpxUmk.js")).verifyFilledSvg,
	wallet: async () => (await import("./wallet-DIfrb3jF.js")).walletSvg,
	walletConnect: async () => (await import("./walletconnect-C6fBn7BA.js")).walletConnectSvg,
	walletConnectLightBrown: async () => (await import("./walletconnect-C6fBn7BA.js")).walletConnectLightBrownSvg,
	walletConnectBrown: async () => (await import("./walletconnect-C6fBn7BA.js")).walletConnectBrownSvg,
	walletPlaceholder: async () => (await import("./wallet-placeholder-DdE8R7UV.js")).walletPlaceholderSvg,
	warningCircle: async () => (await import("./warning-circle-CAvhLNdi.js")).warningCircleSvg,
	x: async () => (await import("./x-CetPrB3D.js")).xSvg,
	info: async () => (await import("./info-EHeGZi7i.js")).infoSvg,
	exclamationTriangle: async () => (await import("./exclamation-triangle-ZSJp1cdF.js")).exclamationTriangleSvg,
	reown: async () => (await import("./reown-logo-3EcfAaSj.js")).reownSvg
};
...
//# sourceMappingURL=wui-text-BTww7Gaj.js.map