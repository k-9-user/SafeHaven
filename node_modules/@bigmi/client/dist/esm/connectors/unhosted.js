import { BaseError, base64ToHex, ChainId, getAddressInfo, hexToBase64, MethodNotSupportedRpcError, ProviderNotFoundError, UserRejectedRequestError, } from '@bigmi/core';
import { ConnectorChainIdDetectionError } from '../errors/connectors.js';
import { createConnector } from '../factories/createConnector.js';
import { debounce } from '../utils/debounce.js';
unhosted.type = 'UTXO';
export function unhosted(parameters = {}) {
            ...
            switch (method) {
                case 'signPsbt': {
                    ...
                    try {
                        ...
                        const err = err_;
                        if (err?.code === 4001) {
                            throw new UserRejectedRequestError('User rejected the signing request');
                        }
