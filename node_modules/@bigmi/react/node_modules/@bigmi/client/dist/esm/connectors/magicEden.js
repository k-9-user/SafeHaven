...
import { MethodNotSupportedRpcError, ProviderNotFoundError, UserRejectedRequestError, base64ToHex, getAddressChainId, hexToBase64 } from "@bigmi/core";
		...
		async request({ method, params }) {
			switch (method) {
				case "signPsbt": {
					...
					return base64ToHex((await this.signTransaction(request)).psbtBase64);
				}
...
function encodeParams(params) {
	return createUnsecuredToken(params);
}
//#endregion
export { magicEden };
