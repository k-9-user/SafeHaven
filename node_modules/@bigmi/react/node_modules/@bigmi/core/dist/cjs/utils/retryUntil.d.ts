//#region src/utils/retryUntil.d.ts
/**
...
declare function retryUntil<T>(condition: () => Promise<T | undefined | null | false>, options?: {
  /** Maximum time to wait in milliseconds (default: 5000ms) */timeout?: number; /** Interval between checks in milliseconds (default: 100ms) */
  interval?: number;
}): Promise<T | undefined>;
//#endregion
export { retryUntil };
