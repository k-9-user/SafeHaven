...
let RpcErrorCode = /* @__PURE__ */ function(RpcErrorCode) {
	...
	*/
	RpcErrorCode[RpcErrorCode["USER_REJECTION"] = -32e3] = "USER_REJECTION";
	/**
...
var UserRejectedRequestError = class extends BaseError {
	constructor(message) {
...
//#endregion
export { MethodNotSupportedRpcError, ParseError, RpcErrorCode, UserRejectedRequestError };
