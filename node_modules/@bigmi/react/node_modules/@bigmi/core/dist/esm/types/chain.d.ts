...
type Chain<formatters extends ChainFormatters | undefined = ChainFormatters | undefined, custom extends Record<string, unknown> | undefined = Record<string, unknown> | undefined> = {
  /** Collection of block explorers */blockExplorers?: {
    [key: string]: ChainBlockExplorer;
    default: ChainBlockExplorer;
  } | undefined; /** ID in number form */
  id: ChainId; /** Human-readable name */
  name: string; /** Collection of RPC endpoints */
  rpcUrls: {
...
type ChainConfig<formatters extends ChainFormatters | undefined = ChainFormatters | undefined, custom extends Record<string, unknown> | undefined = Record<string, unknown> | undefined> = {
  /** Custom chain data. */custom?: custom | undefined; /** Modifies how data is formatted and typed (e.g. blocks and transactions) */
  formatters?: formatters | undefined;
};
type ChainFormatters = {
  /** Modifies how the Block structure is formatted & typed. */block?: ChainFormatter<"block"> | undefined; /** Modifies how the Transaction structure is formatted & typed. */
  transaction?: ChainFormatter<"transaction"> | undefined; /** Modifies how the TransactionReceipt structure is formatted & typed. */
  transactionReceipt?: ChainFormatter<"transactionReceipt"> | undefined; /** Modifies how the TransactionRequest structure is formatted & typed. */
