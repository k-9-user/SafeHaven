 ...
 */
export declare const switchChain: (client: Client, statusManager: StatusManager, step: LiFiStepExtended, process: Process, targetChainId: number, allowUserInteraction: boolean, executionOptions?: ExecutionOptions) => Promise<Client | undefined>;
