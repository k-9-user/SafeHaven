import type { CardProps, ComponentsOverrides, ComponentsVariants, SimplePaletteColorOptions, TabProps, TabsProps } from '@mui/material';
...
declare module '@mui/material/styles' {
    ...
    interface Components {
        ...
        MuiNavigationTabs?: {
            ...
            styleOverrides?: ComponentsOverrides<Omit<Theme, 'components'>>['MuiNavigationTabs'];
            variants?: ComponentsVariants['MuiNavigationTabs'];
        };
        MuiNavigationTab?: {
            defaultProps?: ComponentsPropsList['MuiNavigationTab'];
            styleOverrides?: ComponentsOverrides<Omit<Theme, 'components'>>['MuiNavigationTab'];
