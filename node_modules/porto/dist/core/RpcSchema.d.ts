...
export type Schema = RpcSchema.Eth | Exclude<DeepReadonly<RpcSchema.Wallet>, {
    Request: {
        method: 'wallet_getCapabilities' | 'wallet_getAssets' | 'wallet_getCallsStatus' | 'wallet_getCallsHistory' | 'wallet_getPermissions' | 'wallet_grantPermissions' | 'wallet_revokePermissions' | 'wallet_sendCalls' | 'wallet_prepareCalls' | 'wallet_sendPreparedCalls' | 'wallet_switchEthereumChain';
    };
}> | RpcSchema.From<{
