...
export declare namespace wallet_getCallsHistory {
    /** Parameters for `wallet_getCallsHistory` request. */
    const Parameters: z.ZodMiniObject<{
        /** Account address to get call history for. */
        address: z.ZodMiniTemplateLiteral<`0x${string}`>;
        /** Index to start from. */
        index: z.ZodMiniOptional<z.ZodMiniNumber<number>>;
        ...
        sort: z.ZodMiniUnion<readonly [z.ZodMiniLiteral<"asc">, z.ZodMiniLiteral<"desc">]>;
    }, z.core.$strip>;
    type Parameters = z.infer<typeof Parameters>;
    /** Request for `wallet_getCallsHistory`. */
    const Request: z.ZodMiniObject<{
        method: z.ZodMiniLiteral<"wallet_getCallsHistory">;
        params: z.ZodMiniReadonly<z.ZodMiniTuple<readonly [z.ZodMiniObject<{
            /** Account address to get call history for. */
            address: z.ZodMiniTemplateLiteral<`0x${string}`>;
            /** Index to start from. */
    ...
    const Entry: z.ZodMiniObject<{
        ...
        transactions: z.ZodMiniReadonly<z.ZodMiniArray<z.ZodMiniObject<{
            /** Chain identifier the transaction was executed on. */
            chainId: z.ZodMiniCodec<z.ZodMiniTemplateLiteral<`0x${string}`>, z.ZodMiniNumber<number>>;
            /** Transaction hash. */
            transactionHash: z.ZodMiniTemplateLiteral<`0x${string}`>;
