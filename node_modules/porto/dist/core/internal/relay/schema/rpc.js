...
(function (wallet_getCallsHistory) {
    ...
    wallet_getCallsHistory.Request = z.object({
        method: z.literal('wallet_getCallsHistory'),
        params: z.readonly(z.tuple([wallet_getCallsHistory.Parameters])),
    });
    /** Transactions included in the call bundle. */
    wallet_getCallsHistory.Transaction = z.object({
    ...
    wallet_getCallsHistory.Capabilities = z.object({
    ...
    wallet_getCallsHistory.Entry = z.object({
        /** Capabilities of the bundle. */
        capabilities: wallet_getCallsHistory.Capabilities,
        /** Bundle identifier. */
        id: u.hex(),
        ...
        transactions: z.readonly(z.array(wallet_getCallsHistory.Transaction)),
    });
    /** Response for `wallet_getCallsHistory`. */
    wallet_getCallsHistory.Response = z.readonly(z.array(wallet_getCallsHistory.Entry));
