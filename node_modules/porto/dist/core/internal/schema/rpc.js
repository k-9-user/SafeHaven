...
(function (wallet_getCallsHistory) {
    wallet_getCallsHistory.Parameters = Rpc_relay.wallet_getCallsHistory.Parameters;
    wallet_getCallsHistory.Request = Rpc_relay.wallet_getCallsHistory.Request;
    wallet_getCallsHistory.Transaction = Rpc_relay.wallet_getCallsHistory.Transaction;
    wallet_getCallsHistory.Capabilities = Rpc_relay.wallet_getCallsHistory.Capabilities;
    wallet_getCallsHistory.Entry = Rpc_relay.wallet_getCallsHistory.Entry;
    wallet_getCallsHistory.Response = Rpc_relay.wallet_getCallsHistory.Response;
