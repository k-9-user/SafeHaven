...
export { addFaucetFunds, getAssets, getAuthorization, getCallsHistory, getCallsStatus, getCapabilities, health, verifySignature, } from './internal/relayActions.js';
/**
...
export type Decorator<chain extends Chain | undefined = Chain | undefined, account extends Account.Account | undefined = Account.Account | undefined> = {
     ...
     * @returns Result.
     */
    getCallsHistory: (parameters: RelayActions.getCallsHistory.Parameters) => Promise<RelayActions.getCallsHistory.ReturnType>;
    /**
