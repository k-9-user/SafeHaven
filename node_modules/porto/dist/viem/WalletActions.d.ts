...
declare const supportedWalletActions: ["getAddresses", "getCallsStatus", "getCallsHistory", "getCapabilities", "getChainId", "requestAddresses", "sendCalls", "showCallsStatus", "signMessage", "signTypedData", "showCallsStatus", "waitForCallsStatus", "writeContract"];
...
export declare function getCallsHistory<chain extends Chain | undefined, account extends Account.Account | undefined>(client: Client<Transport, chain, account>, parameters: getCallsHistory.Parameters<account>): Promise<getCallsHistory.ReturnType>;
export declare namespace getCallsHistory {
    type Parameters<account extends Account.Account | undefined = undefined> = Omit<RpcSchema.wallet_getCallsHistory.Parameters, 'address'> & GetAccountParameter<account>;
...
export type Decorator<chain extends Chain | undefined = Chain | undefined, account extends Account.Account | undefined = Account.Account | undefined> = Pick<viem_WalletActions<chain, account> & {
    getCallsHistory: (parameters: getCallsHistory.Parameters<account>) => Promise<getCallsHistory.ReturnType>;
