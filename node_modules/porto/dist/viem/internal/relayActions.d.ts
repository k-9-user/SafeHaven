 ...
 * @returns Result.
 */
export declare function getCallsHistory(client: Client, parameters: getCallsHistory.Parameters): Promise<getCallsHistory.ReturnType>;
export declare namespace getCallsHistory {
    type Parameters = RpcSchema.wallet_getCallsHistory.Parameters;
