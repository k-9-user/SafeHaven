...
export declare function getCallsHistory<config extends Config>(config: config, parameters: getCallsHistory.Parameters): Promise<getCallsHistory.ReturnType>;
export declare namespace getCallsHistory {
    type Parameters<account extends Account.Account | undefined = undefined> = Omit<RpcSchema.wallet_getCallsHistory.Parameters, 'address'> & GetAccountParameter<account> & ConnectorParameter;
