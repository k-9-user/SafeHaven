...
import { addFunds, connect, disconnect, getAdmins, getAssets, getCallsHistory, getPermissions, grantAdmin, grantPermissions, revokeAdmin, revokePermissions, upgradeAccount, verifyEmail } from './core.js';
import { getAdminsQueryKey, getAssetsQueryKey, getCallsHistoryQueryKey, getPermissionsQueryKey } from './query.js';
...
export declare function useCallsHistory<config extends Config = ResolvedRegister['config'], selectData = getCallsHistory.ReturnType>(parameters?: useCallsHistory.Parameters<config, selectData>): useCallsHistory.ReturnType<selectData>;
export declare namespace useCallsHistory {
    type Parameters<config extends Config = Config, selectData = getCallsHistory.ReturnType> = getCallsHistoryQueryKey.Parameters & ConfigParameter<config> & {
...
export declare function useDisconnect<_config extends Config = ResolvedRegister['config'], context = unknown>(parameters?: useDisconnect.Parameters<context>): useDisconnect.ReturnType<context>;
